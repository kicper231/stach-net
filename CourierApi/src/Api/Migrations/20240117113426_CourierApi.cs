    ...
    public partial class CourierApi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeliveryRequestGuid = table.Column<Guid>(type: "uniqueidentifier", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DeliveryGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OfferId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CourierCompanyId", "ContactInfo", "CreatedAt", "Id", "Name" },
                values: new object[,]
                {
                    { 1, "https://courierapistachnet.azurewebsites.net/api", new DateTime(2024, 1, 17, 12, 34, 26, 536, DateTimeKind.Local).AddTicks(2410), 0, "StachnetCompany" },
                    { 2, "https://mini.currier.api.snet.com.pl", new DateTime(2024, 1, 17, 12, 34, 26, 536, DateTimeKind.Local).AddTicks(2494), 0, "SzymonCompany" }
                });
