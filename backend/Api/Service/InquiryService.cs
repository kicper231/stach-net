...
public class InquiryService : IInquiryService
{
    ...
    public InquiryService(IHttpClientFactory clientFactory, IOptions<IdentityManagerSettings> settings)
    {
    ...
    public async Task<InquiryRespondDTO> GetOffersFromOurApi(InquiryDTO requestDTO)
    {
        ...
        //return await response.Content.ReadFromJsonAsync<InquiryRespondDTO>();
    ...
    public async Task<InquiryRespondDTO> GetOfferFromSzymonApi(InquiryDTO requestDTO)
    {
